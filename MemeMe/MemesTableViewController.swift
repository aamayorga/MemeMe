...
let memeEditorViewControllerIdentifier = "MemeEditorViewController"

class MemesTableViewController: UITableViewController {
    
    let cellIdentifier = "memeReuseIdentifier"
    ...
    */
    ...
    @objc func showMemeEditorView() {
        let memeEditorVC = self.storyboard!.instantiateViewController(withIdentifier: memeEditorViewControllerIdentifier) as! ViewController
